...
def get_spa_image_info(path,
    ...
    with futures.ThreadPoolExecutor(num_worker) as executor:
        image_infos_0, image_infos_1, image_infos_2, image_infos_3, image_infos_4 = executor.map(map_func, image_ids)

    return list(image_infos_0) + list(image_infos_1) + list(image_infos_2) + list(image_infos_3) + list(image_infos_4)
